...
<body>
    ...
    <div id="head">
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/dlibrary.png" Height="89px" Width="544px" />
    ...
    <div id="main"><div id="img">
        ...
        <asp:Image ID="Image2" runat="server" ImageUrl="~/img/homeimg.png" Height="314px" 
